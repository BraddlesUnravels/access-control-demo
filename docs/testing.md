...
The container-test harness is organized under:
...
Pull-request diagnostics maintain at most one success comment and one failure comment per pull request. Subsequent passes or failures update the existing comment of that type.
