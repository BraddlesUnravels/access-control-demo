...
| Security architecture | layered security model, trust boundaries, and design decisions | [security-architecture.md](security-architecture.md) |
...
- Auth and RBAC review: security-architecture + access-control + api + architecture
